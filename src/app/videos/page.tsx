...
import { buyLinks, cycleLabel, videosEnabled } from '@/lib/site';
...
export default async function VideosPage() {
  // Whole section is gated on the build-time flag. When off, this route is also
  // redirected in next.config; the guard here is the belt-and-suspenders.
  if (!videosEnabled) redirect('/');
